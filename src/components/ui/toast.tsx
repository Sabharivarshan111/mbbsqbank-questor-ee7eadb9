...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full flex-col p-4 sm:top-0 sm:right-auto sm:left-1/2 sm:-translate-x-1/2 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
