...
export function CustomThemeDialog({ open, onOpenChange }: Props) {
  ...
  const apply = () => {
    ...
    setTheme("custom");
    onOpenChange(false);
    void showRewardedAd("custom-theme");
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-md max-h-[90dvh] overflow-y-auto w-[calc(100vw-2rem)] flex flex-col gap-4"
      >
        <DialogHeader>
        ...
        <div className="sticky bottom-0 -mx-6 -mb-6 px-6 py-3 bg-background border-t flex gap-2">
